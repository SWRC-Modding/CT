...
public:
	...
	public:
...
#if DO_GUARD_SLOW
			if(this == NULL)
				appErrorf("Unlock: Null cache item");
		...
		QWORD GetId(){ return Id; }
		BYTE* GetData(){ return Data; }
		INT GetSize(){ return LinearNext->Data - Data; }
		BYTE GetExtra(){ return Extra; }
		void SetExtra(BYTE B){ Extra = B; }
		INT GetCost(){ return Cost; }
		TCacheTime GetTime(){ return Time; }
	...
	// Accessors.
	FCacheItem* First(){ return CacheItems; }
	FCacheItem* Last(){ return LastItem; }
	FCacheItem* Next(FCacheItem* Item){ return Item->LinearNext; }
