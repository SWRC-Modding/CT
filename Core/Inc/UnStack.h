...
//! @brief UnrealScript intrinsic return value declaration.
...
/**
 * @brief Evaluatable expression item types.
 */
enum EExprToken{
	// Variable references.
...
/**
 * @brief Information about script execution at one stack level.
 */
...
/**
 * @brief Information about script execution at the main stack level.
 *
...
/**
 * @brief Base class for UnrealScript iterator lists.
 */
