class HsBumpDiffBlendMaskIllum extends HardwareShaderWrapper
	native;
...
defaultproperties
{
     ...
     BlendUVScale=1
     BumpUVScale=1
     ShaderImplementation=HardwareShader'HardwareShaders.Bump.DOT3DiffBlendMaskIllum'
}
