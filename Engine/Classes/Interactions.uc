...
enum EInputAction
{
	...
	IST_Press,		// Keypress or button press.
	IST_Hold,		// Key or button stays down (repeated).
	IST_PressHold,	// Key pressed and held for HoldTime (one-time).
    IST_Repeat,		// Held key repeats after specified delay (repeated).
	IST_Release,	// Key released.
	IST_Tap,		// Key released within HoldTime (IST_Release also generated).
	IST_DoubleTap,	// same as above but... double tap.
	IST_Axis,		// Analog axis movement.
};
...
/*C8*/	IK_GameA        ,IK_GameB	    ,IK_GameX	    ,IK_GameY	    ,
/*CC*/	IK_GameBlack    ,IK_GameWhite   ,IK_GameLTrig	,IK_GameRTrig   ,
/*D0*/	IK_GameDUp      ,IK_GameDDown   ,IK_GameDLeft	,IK_GameDRight	,
/*D4*/	IK_GameStart	,IK_GameBack	,IK_GameLStick	,IK_GameRStick  ,
