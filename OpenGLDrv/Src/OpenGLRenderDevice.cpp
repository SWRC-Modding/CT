...
"layout(location = 1)  uniform int StageTexCoordIndices[8];\n"
"layout(location = 9)  uniform mat4 StageTexMatrices[8];\n"
"layout(location = 17) uniform int StageColorArgs[16];\n"
"layout(location = 33) uniform int StageColorOps[8];\n"
"layout(location = 41) uniform int StageAlphaArgs[16];\n"
"layout(location = 57) uniform int StageAlphaOps[8];\n"
"layout(location = 65) uniform vec4 ConstantColor;\n"
"\n"
...
"	Specular = InSpecular;\n"
"\n"
"	const vec4 TexCoords[] = vec4[](InTexCoord0, InTexCoord1, InTexCoord2, InTexCoord3, InTexCoord4, InTexCoord5, InTexCoord6, InTexCoord7);\n"
"\n"
"	for(int i = 0; i < NumStages; ++i)\n"
"		StageTexCoords[i] = StageTexMatrices[i] * TexCoords[StageTexCoordIndices[i]];\n"
"\n"
