...
FString UOpenGLRenderDevice::FixedFunctionFragmentShaderText(
	...
	"\n"
		...
		"\tcase CA_Constant:\n"
			...
			"\t\tbreak;\n"
		"\tcase CA_Texture0:\n"
			"\t\tResult = texture2D(Texture0, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture1:\n"
			"\t\tResult = texture2D(Texture1, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture2:\n"
			"\t\tResult = texture2D(Texture2, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture3:\n"
			"\t\tResult = texture2D(Texture3, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture4:\n"
			"\t\tResult = texture2D(Texture4, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture5:\n"
			"\t\tResult = texture2D(Texture5, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture6:\n"
			"\t\tResult = texture2D(Texture6, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tcase CA_Texture7:\n"
			"\t\tResult = texture2D(Texture7, StageTexCoords[StageIndex].xy);\n"
			"\t\tbreak;\n"
		"\tdefault:\n"
