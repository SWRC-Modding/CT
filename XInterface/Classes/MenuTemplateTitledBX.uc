...
defaultproperties
{
     XButtonIcon=(DrawPivot=DP_MiddleRight,PosX=0.105,PosY=0.896,Platform=MWP_Console,Style="XboxButtonX")
     XLabel=(Text=": OPTIONS",DrawPivot=DP_MiddleLeft,PosX=0.095,PosY=0.896,Platform=MWP_Console,Style="LabelText")
